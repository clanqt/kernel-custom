...
static struct nuc970fb_display nuc970fb_lcd_info[] = {
	...
	[0] = {
		 .type           = LCM_DCCS_VA_SRC_RGB565,
                 ...
                 .lower_margin   = 3,//3
                 .vsync_len      = 1,//1
                 .dccs           = 0x0e00040a,//0x0e00240a
                 .fbctrl         = 0x00780078,//0x00780078
                 .devctl         = 0x460800C0,//0x260800C0
                 .scale          = 0x04000400,//0x04000400
	},
#endif
...
static struct i2c_board_info __initdata at24_platform_data[] = {
{
...
/*
static struct i2c_board_info __initdata CTP_board_info[] = {
{
...
void __init nuc970_platform_init(struct platform_device **device, int size)
{
	...
	i2c_register_board_info(0, nuc970_i2c_clients0, sizeof(nuc970_i2c_clients0)/sizeof(struct i2c_board_info));
    	i2c_register_board_info(0, nfc_board_info, sizeof(nfc_board_info)/sizeof(struct i2c_board_info));
    	i2c_register_board_info(0, at24_platform_data, sizeof(at24_platform_data)/sizeof(struct i2c_board_info));
//    	i2c_register_board_info(0, CTP_board_info, sizeof(CTP_board_info)/sizeof(struct i2c_board_info));
#endif
