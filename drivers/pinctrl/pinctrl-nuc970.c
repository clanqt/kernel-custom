...
static const unsigned uart10_0_pins[] = {0x1A}; // tx, rx
...
static const unsigned spi0_0_pins[] = {0x18, 0x19};
//static const unsigned spi0_1_pins[] = {0x1A, 0x1B}; // quad
static const unsigned spi0_1_pins[] = {0x1A}; // quad
...
static const unsigned can0_0_pins[] = {0x1A}; // Port B
